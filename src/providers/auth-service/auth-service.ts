...
export class AuthService {
  ...
  validaUbicacion(lat,lng) {
    var R = 6371; // Radius of the earth in km
    var lat1 = lat;
    var lng1 = lng;
    var lat2 = this.AuthToken.planta.billinglatitude;
    var lng2 = this.AuthToken.planta.billinglongitude;
    ...
    return distancia > this.AuthToken.planta.radio__c;
  }
